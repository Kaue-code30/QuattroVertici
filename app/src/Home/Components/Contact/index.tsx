...
import LinksHeader, { EmpresasIvestidasLinks, RedeSocial } from "@/app/src/Utils/Links";
...
function Contact() {
    ...
    return (
        <section id="contato" className="w-full h-auto flex items-center justify-center text-white bg-black pt-[100px] pb-[50px]">
            <div className="max-w-[1000px] h-full flex flex-col  items-start gap-3 justify-start w-4/5 lg:w-full">
                ...
                <div className="h-auto flex lg:flex-row flex-col justify-between py-14  w-full">
                    <div className="w-auto flex flex-col lg:pb-0 pb-10 gap-3 h-full">
                        <h1 className="text-white cursor-default pb-2 font-medium text-xl lg:text-3xl">
                            Quattro Vertici
                        </h1>
                        <Link target="_blank" href={"mailto:email@quattrovertici@gmail.com"} className="flex font-light text-sm items-center justify-start gap-1">
                    ...
                    <div className=" flex lg:flex-row flex-col gap-10 lg:gap-20">
                        ...
                        <div className="w-auto h-full">
                            <h2 className="font-light text-xl lg:text-2xl ">
                                Links Úteis:
                            </h2>
                        ...
                        <div className="w-auto h-full">
                            ...
                            <ul className="pt-3 flex flex-col gap-2">
                                {
                                    EmpresasIvestidasLinks.map((data, key) => (
                                        <li key={key} className="relative text-sm font-light py-1 text-white overflow-hidden group">
