...
function Hero() {
    return (
        <section style={{ backgroundImage: `url(${banner.src})` }} className="h-screen lg:h-[97vh] rounded-b-2xl bg-cover  bg-no-repeat bg-center flex items-center justify-center w-full">
            <div className="w-full h-full flex items-center rounded-b-2xl justify-center bg-[#00000086]">
                <div className="max-w-[1000px] w-4/5 lg:w-full h-full gap-3 flex-col flex items-start justify-center  ">
                    ...
                    <button className="w-48 h-10 hover:scale-90 transition duration-300 text-black bg-white rounded-lg">
                        <Link className="w-full h-full flex items-center justify-center" href={"/#quem-somos"}>saiba mais</Link>
                    </button>
                </div>
            </div>
        </section>
