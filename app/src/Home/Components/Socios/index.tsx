...
function OqueAsEmpresasFalam() {
    ...
    return (
        <section id="socios" className="w-full h-auto flex items-center justify-center bg-white pt-[0px] pb-[100px]">
...
export default OqueAsEmpresasFalam;